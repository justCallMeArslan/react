...
- Framework inverts the control of program. It tells the dev what they need.
- Library doesnt invert the control and calls the library where and when the dev
  needs it.
